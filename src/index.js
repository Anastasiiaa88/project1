...
Пример:createDivWithText('loftschool') // создаст элемент div, поместит в него 'loftschool' и вернет созданный элемент
*/
...
function findAllPSiblings(where) {
    var wh = where.children;
    var arr = [ ];

    for ( var i = 0; i < wh.length - 1; i++) {
        if ( wh[i].nextElementSibling.nodeName === 'P') {
            arr.push (wh [ i ]);
        }
    }
